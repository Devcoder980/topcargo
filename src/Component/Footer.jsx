            ...
            <footer className="bg-gradient-to-r from-gray-100 via-[#bce1ff] to-gray-100">
                <div className="max-w-screen-xl px-4 py-16 mx-auto sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
                        <div>
                            <span className='text-3xl font-bold'>Top <span className="text-green-600">Cargo</span></span>
                            <p className="max-w-xs mt-4 text-sm text-gray-600">
                                We are happy to serve transportation delivery service.
                            </p>
                            <div className="max-w-xs mt-4 text-sm text-gray-600">
                                <p>Phone : +91 9586624949  </p>
                                <p>Email : topcargo.india@gmail.com</p>
                            </div>
                        ...
                        <div className="grid grid-cols-1 gap-8 lg:col-span-2 sm:grid-cols-2 lg:grid-cols-4">
                            ...
                            <div>
                                ...
                                <nav className="flex flex-col mt-4 space-y-2 text-sm text-gray-500">
                                    ...
                                    <a className=" hidden md:block hover:opacity-75" href> Accounts Review </a>
